...
export function Testimonials() {
  const reviews = [
    { id: 1, name: "أحمد كمال", role: "مهاجم", text: "التصميم فاق التوقعات! الإضاءة والتفاصيل خرافية، شكراً فيزورا." },
    { id: 2, name: "ياسر الحربي", role: "حارس مرمى", text: "سرعة في الإنجاز واحترافية عالية، البوستر كأنه طالع من لعبة فيفا." },
    { id: 3, name: "فريق المجد", role: "خماسي", text: "صممنا بوستر للفريق كامل والكل انبهر فيه، تعامل راقي جداً." },
    { id: 4, name: "محمود حسن", role: "كابتن فريق", text: "أفضل مكان تصمم فيه بوسترات رياضية، دمج الصور احترافي جداً." },
  ];
